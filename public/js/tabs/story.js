...
export default async function showStoryPage() {
    ...
    document.getElementById('btn-start-story').onclick = async () => {
        ...
        startStoryCreationFlow(myChars);
    };
}
...
function startStoryCreationFlow(myChars) {
    ...
    function showKeywordStep(charId, worldId) {
        ...
        card.querySelector('#btn-generate-sketch').onclick = async () => {
            ...
            const btn = card.querySelector('#btn-generate-sketch');
            btn.disabled = true;
    ...
    function showFinalConfirm(charId, worldId, sketch) {
        ...
        card.querySelector('#btn-cancel').onclick = close;
        card.querySelector('#btn-final-confirm').onclick = async () => {
            const btn = card.querySelector('#btn-final-confirm');
            btn.disabled = true;

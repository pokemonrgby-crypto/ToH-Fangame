...
- **재미성**: 캐릭터 설정이 얼마나 흥미롭고 독창적인지 평가합니다. '무조건 이기는 능력', '조건부 절대 승리', '멍 때림', '뜬금없는 승리' 등 단순하고 일방적인 능력이나, '평범한 회사원'처럼 너무 특징이 없는 설정은 극도로 낮은 점수를 부여합니다. 특히 평범이라는 단어는 해당 캐릭터가 평범하지만 노력한다와 무관하게 캐릭터의 본질이 평범함, 또는 평범이 아니더라도 기본적, 흔한 등도 매우 낮은 점수를 부여합니다.
